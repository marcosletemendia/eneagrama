...
@section('principal')
  <div class="central">
    <h2>Necesidad distintiva del TRES</h2>
    <p>En el TRES, la herida primaria que le origina sensación de agresión,
       ...
       del otro estará vinculada al éxito de esta persona.</p>
  </div>
@endsection
