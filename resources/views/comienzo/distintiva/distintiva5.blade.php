...
@section('principal')
  <div class="central">
    <h2>Necesidad distintiva del CINCO</h2>
    <p>En el CINCO, la herida primaria que le origina sensación de soledad,
       ...
       para acumular información, evitando ser protagonista.</p>
  </div>
@endsection
