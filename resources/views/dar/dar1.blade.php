...
@section('principal')
   <div class="central">
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al CINCO, pasar de la reflexión conceptual a la reflexión aplicada. Le
            dice: <i>ACCIONÁ</i>.</li>
         <li>Al SEIS, pasar de la autoridad exterior a la interior. Le dice: <i>OPINÁ</i>.</li>
         <li>Al SIETE, pasar de la desorganización al método. Le dice: <i>DISCIPLINATE</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al CUATRO, pasar del narcisismo al vínculo con el otro. Le dice: <i>EMPATIZÁ</i>.</li>
         <li>Al CINCO, pasar de su aislamiento a conectarse con el otro. Le dice:
            <i>BRINDATE.</i></li>
         <li>Al SEIS, pasar de la desconfianza al entusiasmo. Le dice: <i>ENTREGATE</i>.</li>
         <li>Al SIETE, pasar de la insensibilidad al cuidado de los afectos. Le dice:
            <i>SENSIBILIZATE</i>.</li>
         <li>Al OCHO, pasar de la impulsividad al respeto por el otro. Le dice: <i>SÉ
            CONSIDERADO</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al DOS, pasar del actuar para los demás a actuar para sí. Le dice:
            <i>PRIORIZATE</i>.</li>
         <li>Al CUATRO, pasar de la ensoñación a la concreción. Le dice: <i>REALIZÁ</i>.</li>
         <li>Al CINCO, pasar de la reclusión a la acción. Le dice: <i>ACTUÁ</i>.</li>
         <li>Al SEIS, pasar de ser indecisión a animarse. Le dice: <i>LANZATE</i>.</li>
         <li>Al SIETE, pasar de la dispersión al logro. Le dice: <i>CONCRETÁ</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al CINCO, pasar de la profundidad ortodoxa a la heterodoxa. Le dice:
            <i>VOLÁ</i>.</li>
         <li>Al SEIS, pasar del deber ser al ser autentico. Le dice: <i>CEDÉ</i>.</li>
         <li>Al SIETE, pasar de lo superficial a lo profundo. Le dice: <i>INTERIORIZÁ</i>.</li>
         <li>Al OCHO, pasar del poder de dominio a la fuerza creadora interior. Le
            dice: <i>CONECTATE</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al DOS, pasar de un dar intencionado a un dar desinteresado. Le dice:
            <i>DIFERENCIÁ</i>.</li>
         <li>Al TRES, pasar del hacer al teorizar. Le dice: <i>CONCEPTUALIZÁ</i>.</li>
         <li>Al CUATRO, pasar de la subjetividad a la universalidad. Le dice: <i>TRASCENDETE</i>.</li>
         <li>Al SEIS, pasar de la híper-estructura a lo correcto. Le dice: <i>DISENTÍ</i>.</li>
         <li>Al SIETE, pasar del desorden a lo medular. Le dice: <i>FOCALIZATE</i>.</li>
         <li>Al OCHO, pasar de la vehemencia a la cautela. Le dice: <i>REFLEXIONÁ</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al CUATRO, pasa de la rebeldía a la aceptación de las normas. Le dice: <i>ACATÁ</i>.</li>
         <li>Al CINCO, pasar del saber para ti al saber para todos. Le dice: <i>COMPARTÍ</i>.</li>
         <li>Al SIETE, pasar de la febrilidad a la responsabilidad. Le dice: <i>SERENATE</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al CUATRO, pasar de la melancolía a la alegría. Le dice: <i>REÍTE</i>.</li>
         <li>Al CINCO, pasar de la estructura a lo lúdico. Le dice: <i>AFLOJATE</i>.</li>
         <li>Al SEIS, pasar de la duda a espontaneidad. Le dice: <i>ANIMATE</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al DOS, pasar de estar siempre disponible a darse un lugar. Le dice:
            <i>PONÉ LIMITES</i>.</li>
         <li>Al TRES, pasar del hacer para lograr el éxito a un hacer ético. Le dice:
            <i>SÉ ALTRUISTA</i>.</li>
         <li>Al CUATRO, pasar de la duda a autoafirmación. Le dice: <i>CONFIÁ EN
            VOS</i>.</li>
         <li>Al CINCO, pasar de la reflexión a la gestión. Le dice: <i>ATREVETE</i>.</li>
         <li>Al SEIS, pasar del miedo a la acción. Le dice: <i>AFIRMATE</i>.</li>
      ...
      <ul style="padding-top:1%;">
         ...
         <li>Al CUATRO, pasar de la comparación a la autovaloración. Le dice: <i>NO
            TE JUZGUES</i>.</li>
         <li>Al CINCO, pasar del enredo intelectual a la simpleza. Le dice:
            <i>ARMONIZATE</i>.</li>
         <li>Al SEIS, pasar del bloqueo producto de los temores que lo invaden, a la
            serenidad que le permite avanzar. Le dice: <i>CALMATE</i>.</li>
         <li>Al SIETE, pasar de la febrilidad al equilibrio. Le dice: <i>SOSEGATE</i>.</li>
         <li>Al OCHO, pasar de la pasión a mesura. Le dice: <i>MODERATE</i>.</li>
      </ul>
   </div>
@endsection
